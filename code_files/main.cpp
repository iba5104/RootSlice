...
int main()
{
 ...
 //   double cortexRadiusInput = 0;
    ...
    for (baseRadiusInt = 1.1; baseRadiusInt <= 1.1; baseRadiusInt++)
    {
        baseRadius = 100 * baseRadiusInt;

        for (rcaRatioInt = 0; rcaRatioInt <= 0; rcaRatioInt++)
        {
            rcaRatioInput = 0.01 * rcaRatioInt;

            for (corticalCellAddRadiusMinInput = 10; corticalCellAddRadiusMinInput <= 10; corticalCellAddRadiusMinInput = corticalCellAddRadiusMinInput + 5)
                //corticalCellAddRadiusMinInput = 0;
            {
                for (gapCellWallInputInt = 1.0; gapCellWallInputInt <= 1.0; gapCellWallInputInt = gapCellWallInputInt + 0.5)
                {
                    gapCellWallInput = gapCellWallInputInt * 1;

                    for (gapCytoTonoInputInt = 0.2; gapCytoTonoInputInt <= 0.2; gapCytoTonoInputInt = gapCytoTonoInputInt + 2.5)
                    {
                        gapCytoTonoInput = 1 * gapCytoTonoInputInt;
