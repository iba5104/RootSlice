...
void rsPXBoundaryDB::BoundaryRotateRadian()
{
...
void rsPXBoundaryDB::RadianUniformDB(int dotNum)
{
	double temp;
	int i;
...
void rsPXBoundaryDB::BoundaryPointRotateRadianDB()
{
...
void rsPXBoundaryDB::BoundaryPointXYLeftAndRightHemisphere(int dotNum)
{
...
void rsPXBoundaryDB::BoundaryRadianStartAndEndDB()
{
	vector<double>::iterator itVec;
	int i;
...
void rsPXBoundaryDB::BoundaryTangentCenterRadiusDB()
{
	vector<double>::iterator itVec;
	int i;
	double temp;
...
void rsPXBoundaryDB::BoundaryTangentUpAndDownLengthDB()
{
	vector<double>::iterator itVec;
	int i;
	double tempUp;
...
void rsPXBoundaryDB::SetUpAndDownRowNum(int setUpRowNum, int setDownRowNum)
{
	double tempUpNum;
	double tempDownNum;
	...
	tempUpNum = ceil(double(1) / double(3) * double(upRowNum));
	tempDownNum = ceil(double(1) / double(2) * double(downRowNum));
...
void rsPXBoundaryDB::BoundaryTangentUpAndDownLengthSegmentDB()
{
	vector<double>::iterator itVec;
	int i;
	double tempUp;
...
void rsPXBoundaryDB::BoundaryTangentUpAndDownLengthSegmentAppendRadiusDB()
{
	vector<double>::iterator itVec;
...
void rsPXBoundaryDB::BoundaryPointRightHemisphereCenterDistanceDB()
{
...
void rsPXBoundaryDB::BoundaryPointRightUpDownXYHemisphereTargetDB()
{
...
void rsPXBoundaryDB::BoundaryRadianStartPointXYDB()
{
...
void rsPXBoundaryDB::BoundaryPointRightUpAndDownHemisphereTargetIntersectionRadianDB()
{
	map<int, vector<double> >::iterator itMapX;
	vector<double>::iterator itVecX;
	map<int, vector<double> >::iterator itMapY;
...
void rsPXBoundaryDB::BoundaryPointRightAndLeftUpAndDownHemisphereTargetCenterRadian()
{
	map<int, vector<double> >::iterator itMap;
	vector<double>::iterator itVec;
...
void rsPXBoundaryDB::BoundaryUpAndDownCellObjectVerticalDB()
{
...
void rsPXBoundaryDB::BoundaryUpAndDownCellCenterRadiusDB()
{
...
void rsPXBoundaryDB::BoundaryCellUpAndDownNumDB()
{
	int i;
	int tempRound;
	ofstream fout("a.txt", ios::app);
...
void rsPXBoundaryDB::BoundaryUpAndDownCellObjectParallelDB()
{
	map<int, vector<double> >::iterator itMapUp;
	map<int, vector<double> >::iterator itMapDown;
	vector<double>::iterator itVecUp;
...
void rsPXBoundaryDB::BoundaryPointRightUpAndDownHemisphereTargetIntersectionRadianDivideDB()
{
	map<int, vector<double> >::iterator itMapUp;
	map<int, vector<double> >::iterator itMapDown;
	vector<double>::iterator itVecUp;
...
void rsPXBoundaryDB::BoundaryCellLeftAndRightUpAndDownCenterRadianDB()
{
	map<int, vector<double> >::iterator itMapUp;
	map<int, vector<double> >::iterator itMapDown;
	vector<double>::iterator itVecUp;
...
void rsPXBoundaryDB::BoundaryCellLeftAndRightUpAndDownCenterRotateAngleDB()
{
...
void rsPXBoundaryDB::BoundaryCellLeftAndRighUpAndDownXYDB()
{
	map<int, vector<vector<double> > >::iterator itMap;
	vector<vector<double> >::iterator itVec2;
	vector<double>::iterator itVec1;
...
void rsPXBoundaryDB::BoundaryCellObjectHeightAndZPositionDB(int sliceNum)
{  /// declare iterator;
	map<int, vector <vector<double> > >::iterator itMap;
	vector< vector<double> >::iterator itVec2;
	vector<double>::iterator itVec1;
	...
	int sliceNum)
{
	...
	this->BoundaryPointRotateRadianDB();
	...
	this->BoundaryTangentUpAndDownLengthDB();

	this->SetUpAndDownRowNum(setUpRowNum, setDownRowNum);

	this->BoundaryTangentUpAndDownLengthSegmentDB();

	this->BoundaryTangentUpAndDownLengthSegmentAppendRadiusDB();

	this->BoundaryPointRightHemisphereCenterDistanceDB();

	this->BoundaryPointRightUpDownXYHemisphereTargetDB();

	this->BoundaryRadianStartPointXYDB();

	this->BoundaryPointRightUpAndDownHemisphereTargetIntersectionRadianDB();

	this->BoundaryPointRightAndLeftUpAndDownHemisphereTargetCenterRadian();

	this->BoundaryUpAndDownCellObjectVerticalDB();

	this->BoundaryUpAndDownCellCenterRadiusDB();

	this->BoundaryCellUpAndDownNumDB();

	this->BoundaryUpAndDownCellObjectParallelDB();

	this->BoundaryPointRightUpAndDownHemisphereTargetIntersectionRadianDivideDB();

	this->BoundaryCellLeftAndRightUpAndDownCenterRadianDB();

	this->BoundaryCellLeftAndRightUpAndDownCenterRotateAngleDB();

	this->BoundaryCellLeftAndRighUpAndDownXYDB();

	this->BoundaryCellObjectHeightAndZPositionDB(sliceNum);
}